...
$(function() {
	$("img[src*='ct_icon_date.gif']").on("click", function () {
...
<form name="detailForm" method="post" nctype="multipart/form-data">
	...
	<tr>
		...
		<td class="ct_write01">
			<input	type="file" name="fileName" class="ct_input_g" 
						style="width: 200px; height: 19px" maxLength="13" value="${product.fileName}" multiple="multiple"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
